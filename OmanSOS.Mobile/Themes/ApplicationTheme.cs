...
namespace OmanSOS.Mobile.Themes;
...
public class ApplicationTheme : MudTheme
{
    public ApplicationTheme()
    {
        Palette = new Palette
        {
            ...
            AppbarBackground = ColorConfig.APPBAR_BACKGROUND,
            DrawerBackground = ColorConfig.DRAWER_BACKGROUND,
            DrawerText = ColorConfig.DRAWER_TEXT,
        };
